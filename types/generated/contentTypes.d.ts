...
export interface ApiBlogAuthorBlogAuthor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    allSocialLinks: Schema.Attribute.Component<
...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    bannerImageUrl: Schema.Attribute.String;
    ...
    blogAuthor: Schema.Attribute.Relation<
      ...
      'api::blog-author.blog-author'
    >;
    breadcrumb: Schema.Attribute.Relation<
      'manyToOne',
...
export interface ApiBreadcrumbInitialBreadcrumbInitial
  extends Struct.CollectionTypeSchema {
  collectionName: 'breadcrumb_initials';
  info: {
    displayName: 'BreadcrumbInitial';
    pluralName: 'breadcrumb-initials';
    singularName: 'breadcrumb-initial';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    group: Schema.Attribute.Relation<'oneToMany', 'api::blog.blog'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::breadcrumb-initial.breadcrumb-initial'
    ...
    paths: Schema.Attribute.Component<'shared.breadcrumb-items', true>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
